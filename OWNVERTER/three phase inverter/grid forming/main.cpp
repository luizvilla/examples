...
void apply_complementary_duty(three_phase_t duty)
{
    ...
    duty_cycle_2 = clamp_duty(duty.b);
    duty_cycle_3 = clamp_duty(duty.c);
    shield.power.setDutyCycle(LEG1, duty_cycle_1 * 0.9F);
    shield.power.setDutyCycle(LEG2, duty_cycle_2 * 0.9F);
    shield.power.setDutyCycle(LEG3, duty_cycle_3 * 0.9F);
}
...
void setup_scope()
{
    ...
    scope.connectChannel(Vgrid_meas.a, "V1");
    scope.connectChannel(Vgrid_meas.b, "V2");
    scope.connectChannel(Vgrid_meas.c, "V3");
