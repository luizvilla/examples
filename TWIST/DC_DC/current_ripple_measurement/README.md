...
Current ripple measurement in buck voltage mode, by sweeping adc trigger This example demonstrates the key setup, control flow, and expected outputs for this application.
